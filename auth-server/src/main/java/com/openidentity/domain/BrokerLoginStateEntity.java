...
@Entity
@Table(name = "broker_login_state")
public class BrokerLoginStateEntity {
  @Id
  ...
  private OidcIdentityProviderEntity provider;
  ...
  public OidcIdentityProviderEntity getProvider() {
    return provider;
  }

  public void setProvider(OidcIdentityProviderEntity provider) {
