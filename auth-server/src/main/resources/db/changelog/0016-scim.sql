-- SCIM 2.0 provisioning skeleton.
-- Stores inbound SCIM User and Group resources received from enterprise directories.
-- This is the data foundation; the /scim/v2/ resource server is implemented in
-- ScimResource.java (Phase 4 in-progress).
