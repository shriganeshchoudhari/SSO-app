...
class SelectToggleBase extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            isTypeahead && (React.createElement("div", Object.assign({}, props, { ref: this.toggle, className: css(styles.selectToggle, hasPlaceholderStyle && styles.modifiers.placeholder, isDisabled && styles.modifiers.disabled, isPlain && styles.modifiers.plain, isTypeahead && styles.modifiers.typeahead, className), onBlur: onBlur, onClick: (event) => {
                    if (!isDisabled) {
                        onToggle(event, !isOpen);
                        if (isOpen) {
                            onClose();
