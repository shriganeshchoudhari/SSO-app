...
const pf_logo_svg_1 = tslib_1.__importDefault(require("@patternfly/react-core/src/demos/assets/pf-logo.svg"));
    ...
    return (react_1.default.createElement(components_1.Masthead, null,
        ...
        react_1.default.createElement(components_1.MastheadMain, null,
            react_1.default.createElement(components_1.MastheadBrand, null,
                react_1.default.createElement(components_1.Brand, { src: pf_logo_svg_1.default, alt: "PatternFly", heights: { default: '36px' } }))),
        react_1.default.createElement(components_1.MastheadContent, null,
            react_1.default.createElement(components_1.Toolbar, { id: "toolbar", isFullHeight: true, isStatic: true },
                react_1.default.createElement(components_1.ToolbarContent, null,
                    react_1.default.createElement(components_1.ToolbarGroup, { variant: "icon-button-group", align: { default: 'alignRight' }, spacer: { default: 'spacerNone', md: 'spacerMd' } }, notificationBadge !== null && notificationBadge !== void 0 ? notificationBadge : (react_1.default.createElement(components_1.ToolbarItem, null,
