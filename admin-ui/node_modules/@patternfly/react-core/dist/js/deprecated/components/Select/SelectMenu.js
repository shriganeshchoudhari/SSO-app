...
class SelectMenuWithRef extends React.Component {
    ...
    renderSelectMenu({ variant, inputIdPrefix }) {
        ...
        let Component = 'div';
        const variantProps = Object.assign({ ref: innerRef, className: (0, react_styles_1.css)(!footer ? select_1.default.selectMenu : `${select_1.default.selectMenu}-list`, position === selectConstants_1.SelectPosition.right && select_1.default.modifiers.alignRight, className) }, (maxHeight && { style: { maxHeight, overflow: 'auto' } }));
