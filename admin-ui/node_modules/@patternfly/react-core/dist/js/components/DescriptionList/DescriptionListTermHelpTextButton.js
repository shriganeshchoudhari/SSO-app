...
const DescriptionListTermHelpTextButton = (_a) => {
    ...
    const helpTextRef = React.createRef();
    ...
    return (React.createElement("span", Object.assign({ ref: helpTextRef, className: (0, react_styles_1.css)(className, description_list_1.default.descriptionListText, description_list_1.default.modifiers.helpText), role: "button", type: "button", tabIndex: 0, onKeyDown: (event) => handleKeys(event) }, props), children));
};
