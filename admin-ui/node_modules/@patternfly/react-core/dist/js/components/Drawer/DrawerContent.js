...
const DrawerContent = (_a) => {
    var { className = '', children, panelContent, colorVariant = Drawer_1.DrawerColorVariant.default } = _a, props = tslib_1.__rest(_a, ["className", "children", "panelContent", "colorVariant"]);
